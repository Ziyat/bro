...
class DubiousController extends Controller
{
    ...
    {
        $users = ArrayHelper::getColumn(User::find()->where(['id' => DubiousHelper::getUsersInGroup(Yii::$app->user->identity, new UsersAssignment())])->asArray()->all(), 'id');
